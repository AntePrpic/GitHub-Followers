...
enum PersistenceManager {
    ...
    static func updateWith(favorite: Follower, actionType: PersistenceActionType, completed: @escaping(GitHubError?) -> Void) {
    ...
    static func save(favorites: [Follower]) -> GitHubError? {
        do {
            ...
            return nil // because there's no githubErrors
        } catch {
